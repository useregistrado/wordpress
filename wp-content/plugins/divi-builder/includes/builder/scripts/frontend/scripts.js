  ...
  window.et_pb_init_modules = function() {
    ...
    $(() => {
      ...
      $('.et_pb_shop, .et_pb_wc_upsells, .et_pb_wc_related_products').each(function() {
        let $this_el    = $(this);
        let icon        = '' === $this_el.data('icon') ? '' : $this_el.data('icon');
        let icon_tablet = '' === $this_el.data('icon-tablet') ? '' : $this_el.data('icon-tablet');
        let icon_phone  = '' === $this_el.data('icon-phone') ? '' : $this_el.data('icon-phone');
        let icon_sticky = '' === $this_el.data('icon-sticky') ? '' : $this_el.data('icon-sticky');
        ...
        if (! $overlay.length && $this_el.hasClass('et_pb_wc_related_products')) {
          ...
          icon        = '' === $this_el.data('icon') ? '' : $this_el.data('icon');
          icon_tablet = '' === $this_el.data('icon-tablet') ? '' : $this_el.data('icon-tablet');
          icon_phone  = '' === $this_el.data('icon-phone') ? '' : $this_el.data('icon-phone');
          icon_sticky = '' === $this_el.data('icon-sticky') ? '' : $this_el.data('icon-sticky');
        }
